...
\item Peter Winstanley 指出了第3章拉丁语中的一个一直存在的错误. 
...
如数学家一样, 计算机专家通常以形式语言去表达思想(尤其涉及计算). 
如工程师一样, 他们设计原件, 拼装组件, 构建系统, 权衡各种方案. 
如科学家一样, 他们观察复杂系统的行为, 小心假设, 积极求证. 
...
%some variation.
\item[循环执行:] 重复执行, 但内里略有变化(在宿命轮回中不断尝试, 于既定界限处终达彼岸). 
